import { GMAIL_MODIFY_SCOPE, GMAIL_SESSION_STATES } from "@/lib/auth/constants";
...
export function hasGrantedGmailModifyScope(grantedScopes) {
  return Array.isArray(grantedScopes) && grantedScopes.includes(GMAIL_MODIFY_SCOPE);
}
