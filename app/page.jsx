          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <h1 className="max-w-3xl text-4xl leading-none font-semibold tracking-[-0.05em] text-white sm:text-6xl">
                Pidgeot now has the Gmail scanner, classification, and safe one-click unsubscribe foundations, not the cleanup engine yet.
              </h1>
              <p className="max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
                This phase adds safe RFC 8058 unsubscribe execution on top of the server-side
                incremental scanner, metadata-only Gmail retrieval, sender grouping,
                deterministic classification, and server-only unsubscribe resolution for a mailbox
                cleaner that stays explicit, bounded, and temporary by design.
              </p>
            </div>
          ...
          <section className="grid gap-3 rounded-[24px] border border-white/10 bg-[rgba(16,23,38,0.9)] p-4">
            ...
            {session ? (
              ...
              <div className="rounded-2xl border border-dashed border-amber-300/30 bg-amber-300/8 px-4 py-3 text-sm text-amber-100">
                Add the Google OAuth environment variables to enable sign-in. The scanner foundation requires an authenticated Gmail-capable session.
              </div>
            )}
          </section>
        </header>
          ...
          <div className="grid gap-4 rounded-[28px] border border-white/12 bg-[rgba(7,11,19,0.82)] p-5 md:p-6">
            ...
            <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(135deg,rgba(244,201,93,0.1),rgba(244,201,93,0.02))] p-4">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-200">
                Phase 4B keeps the UI as a marked product preview. The counters and sender groups
                below are still mock data while richer unsubscribe controls and cleanup are staged
                behind later application flows.
              </p>
            </div>
